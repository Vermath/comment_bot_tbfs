...
def ask_gpt4o_mini(question):
    ...
    for _ in range(3):
        response = client.chat.completions.create(
            model="ft:gpt-4o-mini-2024-07-18:raptive-nonprod:tbfs-commentbot-v1:A0ZxOGB0",
            messages=[
                {"role": "system", "content": "You are a helpful assistant for Tastes Better From Scratch. Your goal is to respond to comments from our users. Do not under any circumstances use proper names in your responses."},
...
def main():
    ...
    st.title("Tastes Better From Scratch Comment Bot")
    st.write("This is an AI-powered comment bot for www.tastesbetterfromscratch.com. Please note that AI models can sometimes be incorrect or provide unexpected responses.")
